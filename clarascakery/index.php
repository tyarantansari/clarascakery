...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Clara's</span></a>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Made with best ingredients that are personally picked by us to maintain freshness and flavor.</p>
      ...
      <div class="box">
         ...
         <h3>made to order</h3>
         <p>Our cake are fully customizable to your liking from size to flavor to fit your order for any occations.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>We aim to please. Our cake are made with the hope of your most joyous moments and we are very proud to be a part of it.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         <div class="accordion-heading">
            <span>Who made the cake?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         Our fun pastry chefs made your orders.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
         All deliveries from our kitchen should arrive at the location at least 1-2 hours before the event take place (make sure there is a refrigerator to keep the cake from melting) Customer can also pick up their order after contacting us first.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
         Of course! All large orders should be made at least three weeks before. All changes for the detail of the cake and customers detail should be made at least 1 week before or the order would follow original order.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
         No need to worry. We take our customer safety and happiness very highly. Our kitchen and tools would be thoroughly cleaned to prevent any mishaps.
         </p>
      </div>
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>Do you offer vegan cake?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         You can make adjustment to your order beforehand and we would substitute any non vegan items for you.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>our address</h3>
         <p>Jl. Jambe RT. 01 RW. 12</p>
      </div>

      <div class="box">
         <i class="fas fa-clock"></i>
         <h3>opening hours</h3>
         <p>08:00 am to 07:00 pm</p>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>email address</h3>
         <p>clarascakery@cake.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Clara's Cakery</span> | all rights reserved!
   </div>
